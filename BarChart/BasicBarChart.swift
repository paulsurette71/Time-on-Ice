...
class BasicBarChart: UIView {
    ...
    private func drawBar(xPos: CGFloat, yPos: CGFloat, color: UIColor) {
        ...
        barLayer.shadowOpacity = 0.75
        barLayer.shadowOffset  = CGSize(width: -1, height: 1)
        barLayer.shadowRadius  = 2
        barLayer.shadowPath = UIBezierPath(rect: barLayer.bounds).cgPath
        barLayer.shouldRasterize = true
        
        barLayer.rasterizationScale = UIScreen.main.scale
